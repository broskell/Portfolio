...
const projects = [
  ...
  {
    title: 'Roast My Project — AI Feedback SaaS',
    subtitle: 'AI Feedback SaaS · Multi-Model Router',
    description:
    ...
    liveUrl: 'https://roast-my-project.vercel.app/',
    githubUrl: 'https://github.com/broskell/Roast-My-Project',
    image: '/assets/roast_my_project_preview.png',
    featured: true,
    order: 1,
    status: 'Live',
    highlights: [
  ...
  {
    title: 'Alimony.AI — Legal-Tech SaaS',
    subtitle: 'Legal-Tech SaaS · Indian Family Law',
    description:
    ...
    liveUrl: 'https://alimony-ai.vercel.app/',
    githubUrl: 'https://github.com/broskell/Alimony.AI',
    image: '/assets/alimony_preview.png',
    featured: true,
    order: 2,
    status: 'Live',
    highlights: [
      'Rajnesh v. Neha calculator',
      'Sub-second SSE chat response',
      'Prisma ORM & PostgreSQL',
      'Appointment booking',
    ],
  },
  {
    title: 'SINGULARITY — Cinematic 3D Web Experience',
    subtitle: 'Cinematic 3D Web Experience',
    description:
    ...
    techStack: ['Next.js', 'Three.js', 'React Three Fiber', 'GLSL', 'GSAP', 'Lenis'],
    liveUrl: 'https://singularity-nine-virid.vercel.app/',
    githubUrl: 'https://github.com/broskell/Singularity',
    image: '/assets/singularity_preview.png',
    featured: true,
    order: 3,
    status: 'Live',
    highlights: [
      '11-scene scrollytelling',
      'Custom GLSL shaders',
      'Audio-reactive interaction',
  ...
  },
  {
    ...
    description:
      'Delivered first end-to-end live client deployment: normalised PostgreSQL schema, REST APIs in PHP, RBAC, search and pagination in React.',
    techStack: ['React', 'PHP', 'PostgreSQL', 'Tailwind CSS', 'REST APIs'],
    liveUrl: '',
    githubUrl: '',
    image: '',
    featured: false,
    order: 7,
    status: 'Built · Client Live',
  },
  {
  ...
  },
  {
    title: 'Fitness App',
    description:
      'A progressive web application for tracking fitness routines and workouts, built using Vite and optimized for mobile installation.',
    techStack: ['Vite', 'PWA Builder'],
    liveUrl: '',
    githubUrl: '',
    image: '',
    featured: false,
  ...
  {
    title: 'Lexis AI Note-Taking',
    description:
      'AI-powered note-taking and summarization platform leveraging Hugging Face transformers and NLP model pipelines.',
    techStack: ['Hugging Face', 'NLP'],
    liveUrl: '',
    githubUrl: '',
    image: '',
    featured: false,
  ...
  {
    title: 'Solar System Scrollytelling',
    description:
      'An interactive scrollytelling experience visualizing the solar system with real-time 3D rendering in Three.js and React Three Fiber.',
  ...
  {
    title: 'Honey — Study Chatbot',
    description:
      'A responsive chatbot assistant helping students with core subjects and query resolution using NLP.',
    techStack: ['NLP', 'AI Chatbot'],
    liveUrl: '',
    githubUrl: '',
    image: '',
    featured: false,
  ...
  {
    title: 'Advanced UI Replicas',
    description:
      'A collection of highly polished, responsive replicas of complex modern user interfaces.',
